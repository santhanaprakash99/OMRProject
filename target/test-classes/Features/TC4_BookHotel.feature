...
Feature: Verifying omrbranch.com Book Hotel Details
  ...
  Scenario Outline: Verifying Book Hotel including GST and select Debit card  or Credit card with special request
    ...
    When User add guest details "<salutation>","<firstName>","<lastName>","<mobileNO>" and "<>"
    And User add the GST details "<regNo>","<companyName>" and "<companyAddress>"
    And User add special request "Need Valet Parking"
  ...
  Scenario Outline: Verifying Book Hotel including GST and select Debit card or credit card without special request
    ...
    And User proceeds payment options "<cardType>"
      | CardType          | CardNo           | CardName        | Year  | Month | Cvv |
      | visa              | 5555555555552222 | santhanaprakash | April |  2025 | 123 |
      | Amex              | 5555555555552222 | santhanaprakash | April |  2025 | 123 |
      | Mastercard        | 5555555555552222 | santhanaprakash | April |  2025 | 123 |
      | Discover          | 5555555555552222 | santhanaprakash | April |  2025 | 123 |
      | Credit visa       | 5555555555552223 | santhanaprakash | April |  2025 | 123 |
      | Credit Amex       | 5555555555552223 | santhanaprakash | April |  2025 | 123 |
      | Credit Mastercard | 5555555555552223 | santhanaprakash | April |  2025 | 123 |
      | Credit Discover   | 5555555555552223 | santhanaprakash | April |  2025 | 123 |
    ...
    Examples: 
      | userName                    | password   | stateName  | cityName | roomType | checkInDate | checkOutDate | rooms | adults | children | salutation | firstName | lastName | mobileNO   | email                       | regNo      | companyName  | companyAddress         | cardType    |
  ...
  Scenario Outline: Verfying Book Hotel Without GST and select Debit card  with special request
    ...
    Examples: 
      ...
      | santhanaprakash99@gmail.com | Greens@123 | Tamil Nadu | Chennai  | Standard | 2023-05-30  | 2023-05-31   | 1-One | 1-One  |        0 | Mr.        | santhana  | prakash  | 9486063515 | santhanaprakash99@gmail.com | Debit Card |
  ...
  Scenario Outline: Verifying Book Hotel Without GST and select Credit card  without special request
    ...
    When User add guest details "<salutation>","<firstName>","<lastName>","<mobileNO>" and "<email>"
    And User proceeds payment options "<cardType>"
      | visa       | 5555555555552223 | santhanaprakash | April | 2025 | 123 |
      | Amex       | 5555555555552223 | santhanaprakash | April | 2025 | 123 |
      | Mastercard | 5555555555552223 | santhanaprakash | April | 2025 | 123 |
      | Discover   | 5555555555552223 | santhanaprakash | April | 2025 | 123 |
    Then User verify Booking sucess message "Booking is Confirmed" and save the order id
    And User verify booked hotel is same as selected hotel
